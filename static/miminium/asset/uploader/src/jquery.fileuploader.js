...
(function($) {
	...
	$.fn.fileuploader.defaults = {
        ...
        captions: {
            ...
            button: function(options) { return options.limit == 1 ? '选择单个文件' : '选择多个文件'; },
            feedback: function(options) { return options.limit == 1 ? '请选择要上传一个文件' : '请选择全部要上传文件'; },
            
            feedback2: function(options) { return options.length + ' ' + (options.length > 1 ? ' 个文件' : ' 多个文件') + '被选中'; },
            ...
            errors: {
                ...
                filesType: '只有 ${extensions} 类型允许上传的文件。',
